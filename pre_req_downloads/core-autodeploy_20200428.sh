...
try yum -y localinstall tk-8.5.7-5.el6.x86_64.rpm
try yum -y localinstall unixODBC-2.2.14-14.el6.x86_64.rpm
try yum -y localinstall wxBase-2.8.12-1.el6.centos.x86_64.rpm wxGTK-2.8.12-1.el6.centos.x86_64.rpm wxGTK-gl-2.8.12-1.el6.centos.x86_64.rpm
...
try yum -y localinstall $ERLANGPREREQFILES

try yum -y localinstall erlang-R14B-04.3.el6.x86_64.rpm erlang-examples-R14B-04.3.el6.x86_64.rpm

echo "Installing RabbitMQ"
# JC - rabbitmq-server-2.8.7-1.noarch requires a prereq of erlang >= R12B-3

try yum -y localinstall rabbitmq-server-2.8.7-1.noarch.rpm
...
try yum -y localinstall ruby-libs-1.8.7.374-5.el6.x86_64.rpm
try yum -y localinstall ruby-1.8.7.374-5.el6.x86_64.rpm
try yum -y localinstall libdbi-0.8.3-4.el6.x86_64.rpm
...
try yum -y localinstall perl-common-sense-3.5-1.$els.noarch.rpm
...
try yum -y localinstall nspr-4.21.0-1.el6_10.x86_64.rpm nspr-4.21.0-1.el6_10.i686.rpm nspr-devel-4.21.0-1.el6_10.x86_64.rpm
try yum -y localinstall nss-util-3.44.0-1.el6_10.x86_64.rpm nss-util-3.44.0-1.el6_10.i686.rpm nss-util-devel-3.44.0-1.el6_10.x86_64.rpm
try yum -y localinstall nss-softokn-3.44.0-6.el6_10.x86_64.rpm nss-softokn-3.44.0-6.el6_10.i686.rpm nss-softokn-devel-3.44.0-6.el6_10.x86_64.rpm nss-softokn-freebl-3.44.0-6.el6_10.x86_64.rpm nss-softokn-freebl-3.44.0-6.el6_10.i686.rpm nss-softokn-freebl-devel-3.44.0-6.el6_10.x86_64.rpm
try yum -y localinstall nss-3.44.0-7.el6_10.x86_64.rpm nss-3.44.0-7.el6_10.i686.rpm nss-sysinit-3.44.0-7.el6_10.x86_64.rpm nss-devel-3.44.0-7.el6_10.x86_64.rpm nss-tools-3.44.0-7.el6_10.x86_64.rpm
try yum -y localinstall crontabs-1.10-33.el6.noarch.rpm cronie-1.4.4-16.el6_8.2.x86_64.rpm cronie-anacron-1.4.4-16.el6_8.2.x86_64.rpm postfix-2.6.6-8.el6.x86_64.rpm
...
try yum -y localinstall $zenuprpm
